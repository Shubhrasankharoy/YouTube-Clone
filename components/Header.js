        ...
        <header className='w-screen'>
            <div className='mx-auto p-2 px-3 flex'>
                <div className='w-40 flex items-center justify-center gap-2'>
                    <AlignJustify />
                    {mounted && (
                        <svg className='w-24' xmlns="http://www.w3.org/2000/svg" id="yt-ringo2-svg_yt10" width="93" height="20" viewBox="0 0 93 20" focusable="false" aria-hidden="true">
                            <g>
                ...
                <div className='grow'>
                    <div className='overflow-hidden shadow-md bg-[#efefef] dark:bg-[#222222] cursor-pointer pr-5 p-px rounded-full flex gap-5 justify-center items-center mx-auto w-xl'>
                        <input className='grow outline-0 rounded-l-full p-3 ps-7 bg-white dark:bg-black' type="text" placeholder='Search' />
                        <div className=''>
                            <Search />
                        </div>
                    </div>
